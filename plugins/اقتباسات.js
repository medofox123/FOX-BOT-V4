...
try { 
if (command == 'اقتباسات' || command == 'advice') { 
let img = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4D7C34YzQaxRMaUky7WCmUGgLfOhcy40AteAdZSXediDm6izZFnWOVWOa&s=10'
...
console.log(e)}}
handler.command = ['اقتباسات', 'advice', 'frase2', 'phrase2']
