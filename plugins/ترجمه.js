...
let msg = `*〘الـࢪجاء كـتـابه الـنص لـتࢪجمـته〙*\n\n*｢مع مࢪاعـاه تـحـديد لـغه التـࢪجم｣*\n\nمـثال للتـࢪجمه للعـࢪبيه نكـتب\n\n .ترجمه ar صباح الخير\n\nمـثال وللإنجليزيه نكتب \n\n .ترجمه en صباح الخير `
...
handler.command = /^(ترجمه|traducir|trad)$/i
